...
+ Download my public GPG key [[./aleks_ozolins_public_gpg_key.txt][here]] or =curl -sL https://aleksozolins.com/aleks_ozolins_public_gpg_key.txt | gpg --import= to download and import. 
...
Ever wonder what I'm reading? I started recently keeping track. This represents only a small portion of my library. Additionally, I don't always finish every book I start. Nor do I like all of the books I buy! Don't hesitate to send me an [[mailto:aleks@aleksozolins.com][email]] if you'd like to discuss any of the books below:

#+INCLUDE: "~/docs/org-roam/my_library.org" :lines "7-"
...
#+INCLUDE: "~/docs/org-roam/projects.org::Website" :only-contents t
